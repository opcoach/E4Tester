...
/**
 * This basic class can be used as parent class for any framework that needs to ask an E4 application. 
 * It can be used as a based class for JUnit test case or for robot testcases.
  * 
 * @author olivier
 *
 */
public abstract class E4ApplicationDriver {
	...
	protected void waitActivatedPart() {
		getSync().syncExec(() -> {
	...
	protected MPartStack getPartStack() {
